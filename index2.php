      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#portfolio">Data Situs Sejarah Linge</a></li>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>SIG SITUS SEJARAH LINGE</h2>
            <h3>Sistem informasi ini merupakan aplikasi pemetaan geografis situs sejarah di wilayah Linge kabupaten Aceh Tengah. Aplikasi ini memuat informasi dan lokasi situs sejarah di kampung Linge.</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
            Aplikasi pemetaan geografis Situs Sejarah Linge di kabupaten Aceh Tengah ini memuat informasi dan lokasi dari sejarah kampung Linge. Pemetaan diambil dari data lokasi Google Maps dan data kebenaran terkait situs sejarah yang ada di Linge didapat dari Tokoh Adat, Juru Kunci, Petue, serta buku-buku terkait dengan Sejarah Linge.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Situs Sejarah Wilayah Linge</li>
              <li><i class="ri-check-double-line"></i> Kabupaten Aceh Tengah</li>
            </ul>
            <p class="font-italic">
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            ...
            <p>Situs Sejarah Wilayah Linge</p>
          </div>
          <?php
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>SISTEM INFORMASI GEOGRAFIS SITUS SEJARAH LINGE</h3>
          <p> Detail Tempat Situs Sejarah Linge</p>
        ...
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            <div class="section-title">
              <h2>Data situs</h2>
              <p>Halaman ini memuat informasi Tempat situs Sejarah Wilayah Linge Kabupaten Aceh Tengah </p>
            </div>
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Linge, Codepos <br>
              Indonesia <br><br>
              <strong>Phone:</strong> +62 822 9249 2976<br>
              <strong>Email:</strong> ahmadhusairi20072001@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>SIG</span></strong>.
        </div>
        <div class="credits">
